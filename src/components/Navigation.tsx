    ...
    <>
      ...
      <aside className="hidden md:flex flex-col w-64 bg-[#141416] border-r border-surface-800">
        ...
        <div className="p-6 border-b border-surface-800">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold text-white">PerexPastil</h1>
              <p className="text-xs text-surface-500">Point of Sale</p>
            </div>
          </div>
        </div>
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-[#141416] border-t border-surface-800 z-40">
        <div className="flex items-center justify-around p-2">
          ...
          <button
            onClick={logout}
            className="flex flex-col items-center gap-1 px-4 py-2 rounded-lg text-surface-400"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
            </svg>
